<!-- commands/sp-design-system-gate.md -->
...
Use `/sp-design-system-gate` to run Stage 1 manually. The orchestrator (`/the-orchestrator`) invokes this automatically when driving a full plan. No UI feature work should begin until this gate completes.
