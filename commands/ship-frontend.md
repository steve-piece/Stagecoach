<!-- commands/ship-frontend.md -->
<!-- Slash command shim that loads the ship-frontend skill for end-to-end frontend feature delivery via a specialized subagent pipeline. -->
...
Load and follow the [`ship-frontend`](../skills/ship-frontend/SKILL.md) skill.
...
Use `/ship-frontend` to deliver a frontend stage manually. The orchestrator (`/run-pipeline`) routes `type: frontend` stages to this skill automatically.
