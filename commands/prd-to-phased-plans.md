...
Use `/prd-to-phased-plans` once you have a completed PRD and are ready to produce the full implementation plan. The output is the input for `/orchestrator` or individual stage commands (`/feature-delivery`, `/ci-cd-scaffold`).
