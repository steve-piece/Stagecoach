...
- A finalized PRD exists (output of `/prd-generator` or equivalent). Raw briefs, specs, and questionnaires feed `/prd-generator` first.

## When to use this command

Use `/prd-to-phased-plans` once you have a completed PRD and are ready to produce the full implementation plan. The output is the input for `/the-orchestrator` or individual stage commands (`/sp-feature-delivery`, `/sp-ci-cd-scaffold`).
