<!-- commands/sp-frontend-design.md -->
...
Use `/sp-frontend-design` to deliver a frontend stage manually. The orchestrator (`/the-orchestrator`) routes `type: frontend` stages to this skill automatically.
