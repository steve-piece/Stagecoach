...
1. Add a new `Q3 — Stack` option to `skills/bootstrap/SKILL.md`'s plan-mode gate.
2. Add the scaffold invocation to Phase 2.
3. Verify the downstream skills (`sp-design-system-gate`, `sp-ci-cd-scaffold`, `sp-frontend-design`, `sp-feature-delivery`) work with the new stack — many will not without per-stack adapters.
