...
user-invocable: true
triggers: ["frontend stage", "deliver frontend slice", "/sp-frontend-design"]
---
...
This skill does **not** replace `sp-feature-delivery` for backend or full-stack stages. It is invoked only when the stage frontmatter contains `type: frontend`.

---

## Shared Agents (from sp-feature-delivery)

The following agents live in `skills/sp-feature-delivery/agents/` and are reused verbatim — do not recreate them here:

| Agent | File | Purpose |
| --- | --- | --- |
| discovery | [skills/sp-feature-delivery/agents/discovery.md](../sp-feature-delivery/agents/discovery.md) | Codebase + GitNexus recon |
| spec-reviewer | [skills/sp-feature-delivery/agents/spec-reviewer.md](../sp-feature-delivery/agents/spec-reviewer.md) | Spec compliance review |
| quality-reviewer | [skills/sp-feature-delivery/agents/quality-reviewer.md](../sp-feature-delivery/agents/quality-reviewer.md) | Lint, types, test coverage |
| ci-cd-guardrails | [skills/sp-feature-delivery/agents/ci-cd-guardrails.md](../sp-feature-delivery/agents/ci-cd-guardrails.md) | CI/CD safety pass |
...
Phase 1 — Reconnaissance (parallel)
  discovery (haiku, sp-feature-delivery)
...
Phase 7 — Quality Gates (parallel, from sp-feature-delivery)
...
Read `skills/sp-feature-delivery/agents/discovery.md`, then dispatch the discovery subagent. Pass:
- Stage number N
- Path to stage plan
...
1. `skills/sp-feature-delivery/agents/spec-reviewer.md`
2. `skills/sp-feature-delivery/agents/quality-reviewer.md`
3. `skills/sp-feature-delivery/agents/ci-cd-guardrails.md`
