...
- `verdict: fail` with `infrastructure_intact: false` → run `scaffold-ci-cd` skill, then re-dispatch.
...
See `skills/setup/references/model-tier-guide.md` for the full tier philosophy and per-provider alias resolution.
