<!-- skills/ship-feature/agents/quality-reviewer.md -->
...
description: Reviews the implementer's output for code quality — lint, types, test coverage, edge-case handling, security issues, and (for backend/full-stack stages) verifies db/schema.sql was updated before any migration or query code. Runs after the spec reviewer in Phase 4 of the ship-feature orchestrator.
