...
**Architecture:** This is a blocking gate. No feature stage (5+) should begin until every environment variable is populated and `local_dev_boots` is confirmed. The `sp-environment-setup-gate` skill is the execution surface for this stage.
...
Env var groups to populate (project-specific list generated by env-setup-stage-writer):
