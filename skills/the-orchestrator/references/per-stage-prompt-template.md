...
<!-- Supplemental reference: example prompt the-orchestrator constructs for stage-runner dispatch. The authoritative variable list lives in SKILL.md. This file shows how the variables compose into a complete prompt. -->
